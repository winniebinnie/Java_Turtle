...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener,
    ...
    public static void main(String[] a) {
        ...
        new Thread(new BobRectangle(-150, -150, "red")).start();
        new Thread(new BobTriangle(-150, 50, "blue")).start();
        new Thread(new BobDoor(100, -150, "green")).start();
        new Thread(new BobWindow(-100, -75, "black")).start();
